            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a href="#" class="dropdown-item">Règles du classement</a></li>
                        <li><a href="#" class="dropdown-item">Classement général</a></li>
                        <li><a href="#" class="dropdown-item">Mon classement</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
